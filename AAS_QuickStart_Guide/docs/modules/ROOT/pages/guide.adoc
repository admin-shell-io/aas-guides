...
image::qr-code_AASSpec.png[]
image::qr-code_Submodels.png[]

[cols="1,1"]
|===
| image::qr-code_AASSpec.png[] | image::qr-code_Submodels.png[]
| link:https://industrialdigitaltwin.org/en/content-hub/aasspecifications[IDTA Specifications of the AAS] | link:https://industrialdigitaltwin.org/en/content-hub/submodels[IDTA Submodel Templates]
