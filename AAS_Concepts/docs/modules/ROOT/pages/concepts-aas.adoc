...
"I4.0" is an abbreviation for Industrie 4.0 in this context.
...
Following the different identification types from  xref:general.adoc#which-identifiers-for-which-elements[Which Identifiers for Which Elements?], it can be stated that:
...
https://admin-shell.io/idta/cds/manufacturerName/1
